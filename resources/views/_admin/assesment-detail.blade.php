                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-12 text-center">
                            ...
                            <h4>Sudah Ada Juara Utama, tidak dapat meluluskan karya lain</h4>
                            @else
                            <button class="btn btn-success" type="button" data-toggle="modal" data-target="#modalAccept">Luluskan Sebagai Juara Utama</button>
                            @endif
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="modalAccept" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="text-center">
                    <div class="fs-4 fw-bold">Anda yakin ingin meluluskan karya ini sebagai JUARA UTAMA ?</div>
                    <hr>
                    <p class="lead">
                        Nama : {{$user->name}}
                        <br>
                    ...
                    <form action="{{route('need-review-update')}}" class="d-none" method="post" id="form-accept">
                        @csrf
                        <input type="text" name="id" value="{{$user->id}}">
                        <input type="text" name="slug" value="passed">
                    </form>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
