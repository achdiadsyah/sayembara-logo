                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-12 text-center">
                            ...
                            <button class="btn btn-success" type="button" data-toggle="modal" data-target="#modalAccept">Luluskan Review Awal</button>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="modalAccept" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="text-center">
                    <div class="fs-4 fw-bold">Anda yakin ingin mereview karya ini ?</div>
                    <hr>
                    <p class="lead">
                        Nama : {{$user->name}}
                        <br>
                    ...
                    <form action="{{route('need-review-update')}}" class="d-none" method="post" id="form-accept">
                        @csrf
                        <input type="text" name="id" value="{{$user->id}}">
                        <input type="text" name="slug" value="on-review">
                    </form>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
